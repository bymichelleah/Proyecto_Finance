...
<section class="modulo-reportes">
    <section class="titulo-productos">
        ...
        <p class="info">
            En esta sección encontrarás la información de todos los reportes en gráficos del sistema financiero.
        </p>
    </section>
    ...
    <div class="contenedor-graficos">
        {{-- Gráfico 1 --}}
        <div class="card">
            <h3>Distribución de Productos Financieros Activos</h3>
            <canvas id="productosChart"></canvas>
        </div>

        {{-- Gráfico 2 --}}
        <div class="card">
            <h3>Pagos por Sede o Región</h3>
